...
The core of the operation\-: species-\/-\/$>$genes-\/-\/$>$gene seq + exon list -\/-\/$>$ exon\-\_\-seqs. 

For each species retrieves all protein coding genes, and for each of the genes its full sequence and the list of the known exons; assigns dna and protein sequence to each exon and stores it in db. \hypertarget{namespace12__exon__seq__store_aba2efa8f46ef665d66b5f51a0deac1a0}{\index{12\-\_\-exon\-\_\-seq\-\_\-store@{12\-\_\-exon\-\_\-seq\-\_\-store}!strip\-\_\-stop@{strip\-\_\-stop}}
